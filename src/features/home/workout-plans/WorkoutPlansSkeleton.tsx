    ...
    <section className="py-20 font-danaMed relative" dir="rtl">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <div className="h-10 w-64 bg-neutral-800/80 animate-pulse rounded-xl mx-auto mb-4" />
          <div className="h-5 w-80 bg-neutral-800/60 animate-pulse rounded-lg mx-auto" />
        </div>
