...
export default function Testimonials() {
  return (
    <section className="py-24 bg-neutral-950 font-danaMed relative overflow-hidden">
          ...
          {testimonialsData.map((item) => (
            <StaggerItem key={item.id} direction="up">
              <div className="relative group h-full">
                ...
                <div className="relative h-full bg-neutral-900/80 backdrop-blur-lg border border-white/10 rounded-2xl p-6 hover:border-amber-400/50 transition-all flex flex-col justify-between shadow-lg">
                  <div>
                  ...
                  <div className="pt-4 border-t border-white/10 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-amber-500 to-yellow-300 text-neutral-950 font-bold text-xs flex items-center justify-center shadow-md">
                        {item.avatar}
                      </div>
                      <div>
                    ...
                    <div className="flex items-center gap-1 text-[11px] text-neutral-400" title={item.achievement}>
