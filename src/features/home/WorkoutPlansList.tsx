  ...
  return (
    ...
    >
      {displayPlans.map((plan) => (
        <StaggerItem key={plan.id} direction="up" distance={30}>
          <div className="bg-neutral-900/80 backdrop-blur-lg border border-amber-500/20 rounded-2xl p-8 hover:bg-neutral-900 transition-all hover:border-amber-400/50 shadow-[0_0_20px_rgba(234,179,8,0.05)] flex flex-col justify-between h-full">
            <div>
