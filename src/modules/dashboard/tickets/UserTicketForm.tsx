...
export default function UserTicketForm({
  ...
  return (
    <div className="bg-white/[0.03] border border-amber-500/15 rounded-2xl p-6 max-w-2xl mx-auto shadow-2xl font-danaMed">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div>
          ...
          <select
            className="w-full bg-neutral-900 border border-white/10 rounded-xl px-4 py-2.5 text-white focus:outline-none focus:border-amber-500/50 text-sm"
        ...
        {category === "form_check" && (
          <div className="mt-4">
            ...
            <div className="relative group border border-dashed border-amber-500/30 hover:border-amber-500/60 rounded-xl bg-white/5 p-6 text-center cursor-pointer transition-all">
              <input
                type="file"
                accept="video/*,image/*"
              ...
              {selectedFile ? (
                <div className="flex flex-col items-center justify-center gap-2">
                  ...
                  <button
                    ...
                    className="mt-2 text-amber-400 hover:text-amber-300 text-[10px] underline cursor-pointer relative z-10"
                  >
                    حذف فایل
                  </button>
                </div>
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 text-white placeholder:text-neutral-500 focus:outline-none focus:border-amber-500/50 resize-none text-sm"
        ...
        <button
          ...
          className="w-full bg-gradient-to-r from-amber-500 via-amber-400 to-yellow-500 text-neutral-950 font-bold py-3 rounded-xl hover:opacity-95 transition-all text-sm disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer shadow-md"
        >
