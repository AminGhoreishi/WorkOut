          ...
          <div className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-xl p-4">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <div className="text-white/60 text-xs">کل مدیران</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-xl p-4">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <div className="text-white/60 text-xs">مدیران فعال</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-xl p-4">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <div className="text-white/60 text-xs">مدیران مسدود</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-xl p-6 mb-6">
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1 relative">
              ...
              <input
                type="text"
                placeholder="جستجو براساس نام کاربری، ایمیل یا شماره تلفن مدیر..."
                value={searchQuery}
                onChange={(e) => {
