          ...
          {availableTests.length > 0 && (
            <div className="w-full sm:w-auto">
              <select
                ...
                className="w-full sm:w-auto bg-gray-900 border border-white/10 rounded-xl px-4 py-2 text-white text-xs focus:outline-none focus:border-purple-500/50 cursor-pointer"
              >
